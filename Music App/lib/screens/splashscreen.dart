...
import 'package:music_app/screens/oAuthLogin.dart';
...
class _SplashScreenState extends State<SplashScreen> {
  _moveToNextScreen() {
    ...
    */
    ...
    /*
    Since Navigator.push maintains a Stack of Screens thus when pressed back from the Login screen it goes
    back to the splash screen
    So inorder to not push the screen to the stack use below method
    */
    Navigator.pushReplacement(
        context, MaterialPageRoute(builder: (ctx) => OAuthLogin()));
  }
